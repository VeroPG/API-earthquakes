fetch(
  ...
  .then((terremoto) => {
    ...
    for (let i = 0; i < terremoto.features.length; i++) {
      ...
      if (magnitud <= 1) {
        L.marker(coordTerremoto, { icon: icono0_1 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
        ...
        L.marker(coordTerremoto, { icon: icono1_2 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
        ...
        L.marker(coordTerremoto, { icon: icono2_3 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
        ...
        L.marker(coordTerremoto, { icon: icono3_4 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
        ...
        L.marker(coordTerremoto, { icon: icono4_5 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
        ...
        L.marker(coordTerremoto, { icon: icono5_6 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
        ...
        L.marker(coordTerremoto, { icon: icono6_7 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
        ...
        L.marker(coordTerremoto, { icon: icono7_8 })
          .bindPopup(
            "<b>" +
              titulo +
              "</b><br>" +
